...
[👉 Ir a la web desplegada (GitHub Pages)](https://braianruaimi.github.io/Emuna-Tarot/)
...
1. Clona el repo:
   ```sh
   git clone https://github.com/braianruaimi/Emuna-Tarot.git
   ```
2. Abre el proyecto en VS Code o tu editor favorito.
3. Edita los archivos según necesidad.
4. Sube los cambios a `main` para desplegar en GitHub Pages.

## Despliegue automático
Cada push a `main` actualiza la web en:
[https://braianruaimi.github.io/Emuna-Tarot/](https://braianruaimi.github.io/Emuna-Tarot/)

---

### Contacto
Para soporte o personalización, contacta a Bren vía WhatsApp desde la web.
